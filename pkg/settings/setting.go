...
var (
	...
	ScriptUpdateSource    = newSetting("install-script-source-repo", "https://raw.githubusercontent.com/leoluo0818/autok3s/master/k3s-install.sh", "The install script auto update source, github or aliyun oss")
